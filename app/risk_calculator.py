            ...
            dcc.Tab(label='About', children=[
                html.Div([
                    ...
                    dbc.Row([
                        dbc.CardGroup([
                            dbc.Card([
                                dbc.CardImg(src="/assets/Voytek.jpg", top=True,style={"height":"15vw","object-fit":"cover"}),
                                dbc.CardBody(
                                    [
                            ...
                            dbc.Card([
                                dbc.CardImg(src="/assets/Maltepes.jpg", top=True,style={"height":"15vw","object-fit":"cover"}),
                                dbc.CardBody(
                                    [
                            ...
                            dbc.Card([
                                dbc.CardImg(src="/assets/Legner.jpg", top=True,style={"height":"15vw","object-fit":"cover"}),
                                dbc.CardBody(
                                    [
                        ...
                        html.Br(),
                        html.Div([
                            html.A("Here", href="https://covidtracking.com/about-data/data-definitions", style={"display":"inline"}),
                            html.P("is a link which defines each of the variables used in this dashboard.", style={"margin-left": "5px","display":"inline"}),
                    ...
                    ],style={"margin-left":"auto","margin-right":"auto"},no_gutters=True),
                ],style={"min-height":"100vh","padding":"5%","font-size":23,"text-align":"center"})
            ])
        ]),
    ],style={"backgroundColor":"white","margin":"auto","width":"60%"})
],style={'backgroundColor': '#9E1B34','width':'100%','height':'100%'})
